...
function createCard(){
	...
	//I am sure there was an easier way to do this in the inner.HTML option I created above, but I wanted the fucntionality of my delete button to be separate (or at lease that is what I am telling myself)
